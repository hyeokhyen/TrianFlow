...
if __name__ == '__main__':
    ...
    # gt_txt = f'/coc/pcba1/hkwon64/imuTube/repos_v2/odometry/TrianFlow/demo_{dataset_type}/{input_name}_gt.txt'
    result_txt = f'/coc/pcba1/hkwon64/imuTube/repos_v2/odometry/TrianFlow/demo_{dataset_type}/{input_name}.txt'
